...
class PDF extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(50, 7, "Water Level Monitoring", 0, 1);
        $this->Cell(50, 7, "Water Level Report", 0, 1);
...
try {
    ...
    $query = "SELECT * FROM waterlevel WHERE recorded_at BETWEEN ? AND ?";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($data = $result->fetch_assoc()) {
            ...
            $level_value = isset($data['level']) ? $data['level'] : 'N/A';
