...
class PDF extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(50, 7, "PH Level Monitoring", 0, 1);
        $this->Cell(50, 7, "PH Level Report", 0, 1);
        ...
        if ($this->PageNo() >= 1) {
            ...
            $this->Cell(80, 10, "Water Level", 1, 0, "C", true);
    ...
    echo "<script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                ...
                window.location.href = '../water_level.php';
            });
        });
    </script>";
    exit;
...
try {
    ...
    $query = "SELECT * FROM ph_level WHERE recorded_at BETWEEN ? AND ?";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($data = $result->fetch_assoc()) {
            ...
            $level_value = isset($data['ph_sensor']) ? $data['ph_sensor'] : 'N/A';
        ...
        // Output PDF
        $pdf->Output('I', 'water_level_report.pdf');
        exit;
    } else {
