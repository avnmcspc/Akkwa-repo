...
<head>
  ...
  <title>AKKWA | Water Temperature</title>
            ...
            <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <form id="generateReportForm" action="export-to-pdf/water_temperature_report.php" method="POST">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Generate Report for Water Temperature</h5>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <div class="table-responsive">
                                  <table id="WaterTemp" class="table table-striped">
                                    <thead>
                                      <tr>
                                        <th> Temperature </th>
                                        <th> Recorded At </th>
...
<script>
  function loadHistory() {
    fetch("get-readings/get_water_temperature.php")
      .then(response => response.json())
      .then(data => {
        let historyTable = document.getElementById("temperatureLevelList");
        ...
        data.forEach(row => {
          ...
          historyTable.innerHTML += `<tr><td>${row.temperature}</td><td>${formattedDate}</td></tr>`;
        });
        // Initialize DataTable after data is loaded
        if ($.fn.DataTable.isDataTable('#WaterTemp')) {
          $('#WaterTemp').DataTable().destroy();
        }
