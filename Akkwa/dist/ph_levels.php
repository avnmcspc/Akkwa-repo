                          ...
                          <div
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <h4 class="card-title">PH Levels</h4>
                                <div class="table-responsive">
                                  <table id="phLevel" class="table table-striped">
                                    <thead>
                                      <tr>
                                        <th> PH Level </th>
                                        <th> Recorded At </th>
        ...
        <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <form id="generateReportForm" action="export-to-pdf/ph_level_report.php" method="POST">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Generate Report for PH Level</h5>
...
<script>
  function loadHistory() {
    fetch("get-readings/get_ph_level_table.php")
      .then(response => response.json())
      .then(data => {
        let historyTable = document.getElementById("phLevelList");
        ...
        data.forEach(row => {
          ...
          historyTable.innerHTML += `<tr><td>${row.ph_sensor}</td><td>${formattedDate}</td></tr>`;
        });
        // Initialize DataTable after data is loaded
        if ($.fn.DataTable.isDataTable('#phLevel')) {
          $('#phLevel').DataTable().destroy();
        }
